...
void promotePawn(std::vector<Piece> &pieces, int i, int viewTurn, int oppoView, int turnNum, int &offerTurn, bool &wasOffered, bool &wasClaimed, bool caughtUp, std::vector<std::string> &oldInputs, std::vector<std::string> &newInputs, int &inputsRead, std::string finput, bool &needsEntry, char &newValEntered, int* branchPoint, modeType gameMode, int branchLvl);
        ...
        while(gameOver == false)
        {
            ...
            while(gameOver == false) //Start of inner loop. This loop iterates every attempted move.
            {
                ...
                {    
                    ...
                    promotePawn(pieces, i, viewTurn, oppoView, turnNum, offerTurn, wasOffered, wasClaimed, caughtUp, oldInputs, newInputs, inputsRead, finput, readCin, newValEntered, branchPoint, gameMode, branchLvl);
