...
int main(int argc, char **argv)
{
    ...
    while(1)
    {
        ...
        {    
            std::string output;
            output.append(printBoard(oldPieces, oppoTurn, manualClaim, finput, 1)); //prints the board and pieces
...
{
    std::string output;
    output.append(printBoard(pieces, pieces[i].getTeam(), false, " ", 1)); //prints the board and pieces
    ...
    while(newVal == ' ')
    {
        ...
        {
            output.append(printBoard(pieces, pieces[i].getTeam(), false, " ", 1));
