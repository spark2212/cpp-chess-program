...
inline void printCaptureBoxFar(std::vector<Piece> &pieces, int turn);
inline void printCaptureBoxNear(std::vector<Piece> &pieces, int turn);
inline void printTurn(int turnNum, int color, bool manualClaim, bool wasOffered);
...
int main(int argc, char **argv)
{
    ...
    if(argc == 2)
    {
        ...
        while(choice != "auto" && choice != "manual")
        {
            ...
            if(choice == "auto")
            {
                std::cout << "\nAll draws will be automatically declared... \n";
                break;
            }
    ...
    while(1)
    {
        ...
        else
        {
            ...
            printTurn(turnNum, oppoTurn, manualClaim, wasOffered);
...
inline void printTurn(int turnNum, int color, bool manualClaim, bool wasOffered) //This function takes an argument BLACK or WHITE and the current turn number and prints a corresponding string
{
    std::string p1 = "White";
    std::string p2 = "Black";
