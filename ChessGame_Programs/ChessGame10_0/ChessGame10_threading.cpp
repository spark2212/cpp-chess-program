...
//Threads
void cinThread(std::string &T) {std::cin >> T;}
...
int main(int argc, char **argv)
{
    ...
    std::thread th1(cinThread, std::ref(magicWord));
    th1.detach();
        ...
        while(gameOver == false) //Start of inner loop. This loop iterates every attempted move.
        {
            ...
            else if(caughtUp == true)
            {
                ...
                else if((buffer == "i" || buffer == "claim" || buffer == "offer" || buffer == "accept"))
                {
                    ...
                    if(end == "draw" && next != 10 && wasOffered == false) //If Nf3 offer draw
                    {
                        offerTurn = turn;
                    }
                    else if(end == "draw" && next == 10 && wasOffered == false)
                    {
                        offerTurn = oppoTurn;
                    }
                }
